...
<template>
    ...
    <div class="common-layout">
        <el-container class="h-[100vh]">
            <el-aside  class="bg-slate-300 overflow-x-hidden transition-all max-h-screen">
                <SideNav :user="page.props.user" />
            </el-aside>
            <el-container>
                <el-header class="bg-slate-600 flex justify-between items-center text-white" height="60px">
                    <span class="flex gap-1">
                        <Icon :icon="`mdi:${showSide ? 'close' : 'menu'}`" class="text-white text-2xl cursor-pointer" @click="showSide = !showSide" />
