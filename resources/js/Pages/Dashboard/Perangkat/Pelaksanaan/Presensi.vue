    ...
    <el-card>
        ...
        <div class="card-body cetak">
            ...
            <div class="title uppercase font-serif font-bold my-4">
                ...
                <h3 class="text-center">Tahun Pelajaran {{page.props.tapel.label}} Semester {{page.props.semester.label}}</h3>
            </div>
            <div class="meta">
                <table>
                    <tr>
            ...
            <div class="content my-6">
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            <th rowspan="2" class="border border-black p-2 text-center">No</th>
                            <th rowspan="2" class="border border-black p-2 text-center">NISN</th>
                            <th rowspan="2" class="border border-black p-2">NISN</th>
                        </tr>
                        <tr>
                            <th class="border border-black p-2 text-sm" v-for="tgl in tanggals" :key=tgl>{{dayjs(tgl).format('DD/MM')}}</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="(siswa,s) in page.props.rombel.siswas" :key="siswa.nisn">
                            <td class="border border-black p-2 text-center">{{s+1}}</td>
                            <td class="border border-black p-2 text-center">{{siswa.nisn}}</td>
                            <td class="border border-black p-2">{{siswa.nama}}</td>
                            <td class="border border-black p-2" v-for="tgl in tanggals" :key=tgl></td>
                        </tr>
                    </tbody>
                </table>
                </el-scrollbar>
