...
const createAccount = async () => {
    router.post(
        route("user.store", { _query: { type: "App\\Models\\Guru" } }),
...
const edit = (item) => {
    guru.value = item;
    guru.value.sekolah_id = item.sekolahs.map((s) => s.npsn);
    if (item.foto) {
...
const changePage = (e) => {
    router.visit(route(route().current(), { _query: { page: e } }), {
        preserveState: true,
    });
};
</script>
    ...
    <Layout title="Data Guru PAI">
        <div class="wrapper w-full">
            <el-card>
                ...
                <div class="card-body">
                    <!-- {{ page.props.gurus }} -->
                    <el-table :data="gurus" height="75vh">
                        ...
                        <el-table-column label="Satmikal">
                            <template #default="scope">
                                <small>{{
                                    scope.row.sekolahs?.map((s) => s.nama)
                                }}</small>
                            </template>
                        </el-table-column>
                ...
                <el-form v-model="guru" label-position="top">
                    ...
                    >
                        ...
                        <el-image
                            :src="fotoUrl"
                            fit="cover"
                            class="w-[100px] h-[100px] bg-slate-200 rounded-full my-6"
                    ...
                    <el-row class="w-full" :gutter="10">
                        ...
                        <el-col :span="8">
                            <el-form-item
                                label="No Sertifikat PPG"
                                class="w-full"
                            >
                                <el-input
                                    type="text"
                                    style="width: 100%"
                                    placeholder="Masukkan No Sertifikat (jika ada)"
                                    v-model="guru.no_sertifikat"
                                ></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row class="w-full" :gutter="10">
                        ...
                        <el-col :span="18">
                            <el-form-item
                                class="w-full"
                                label="Nama dan Gelar Pendidikan"
                            >
                    ...
                    <el-row class="w-full" :gutter="10">
                        ...
                        <el-col :span="4">
                            <el-form-item class="w-full" label="Status">
                                <el-select
                                    style="width: 100%"
                                    v-model="guru.status_kepegawaian"
                                    placeholder="Pilih Status Pegawai"
                                >
                                    <el-option
                                        v-for="status in ['pns', 'p3k', 'gtt']"
                                        :key="status"
                                        :value="status"
                                        >{{ status.toUpperCase() }}</el-option
                                    >
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="Satmikal">
                                <el-select
                                    v-model="guru.sekolah_id"
                                    placeholder="Pilih Sekolah"
                                    multiple
                                >
                                    <el-option
                                        v-for="sekolah in page.props.sekolahs"
                                        :key="sekolah.npsn"
                                        :value="sekolah.npsn"
                                        :label="sekolah.nama"
                                        >{{ sekolah.nama }}</el-option
                                    >
                                </el-select>
                            </el-form-item>
                        </el-col>
                    ...
                    <el-row class="w-full" :gutter="10">
                        ...
                        <el-col :span="12">
                            <el-form-item label="Akun Belajar.id">
                                <el-input
                                    type="email"
                                    placeholder="Akun Belajar ID"
                                    v-model="guru.belajar_id"
                                ></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
