    ...
    <div>
        <el-card>
            ...
            <div class="cetak w-full p-4 font-serif">
                <Kop />
                <div
                    class="title uppercase text-center font-bold my-6 font-serif"
                >
                ...
                <div class="content my-6">
                    <table class="w-full">
                        <thead>
                            <tr>
                                <th
                                    class="bg-slate-100 p-2 border border-black"
                                >
                                    No
                                </th>
                                <th
                        ...
                        <tbody>
                            <tr
                                v-for="(prota, pr) in page.props.protas"
                                :key="pr"
                            >
                                ...
                                <td class="border border-black p-2">
                                    <ul
                                        v-if="prota.atp && prota.atp.tps"
                                        class="pl-4 list-disc"
                                    >
                                        <li
                                            v-for="tp in prota.atp.tps.split(
                                                ';'
                                            )"
                                            :key="tp.kode"
                                        >
                                    ...
                                    <p
                                        v-else-if="prota.atp && !prota.atp.tps"
                                        class="uppercase"
                                    >
                                        {{ prota.atp.materi }}
                                    </p>
