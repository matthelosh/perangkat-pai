    ...
    <div>
        <el-collapse v-model="activeFase" accordion>
            <h3 class="font-semibold text-lg text-blue-800">
                Elemen Capaian Pelajaran Setiap Fase
            </h3>
            <el-collapse-item
                v-for="(cp, c) in props.cps"
                :key="cp.fase"
                :name="cp.fase"
            >
                <template #title>
